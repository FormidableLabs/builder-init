...
Templates.prototype.load = function (callback) {
  ...
  async.auto({
    ...
    // ------------------------------------------------------------------------
    walkTemplates: ["checkEmpty", function (results, cb) {
      cb = _.once(cb);
      var tmpls = [];
    ...
    // ------------------------------------------------------------------------
    loadIgnore: ["walkTemplates", function (results, cb) {
    ...
    filterTemplates: ["walkTemplates", "loadIgnore", function (results, cb) {
    ...
    // ------------------------------------------------------------------------
    readTemplates: ["filterTemplates", function (results, cb) {
