    ...
    walkTemplates: ["checkEmpty", function (cb) {
      ...
      fs.walk(self.src)
        .on("data", function (item) {
          // TODO HERE: Problem: `demo/`, `test/client`, etc. **aren't** getting copied.
          // ISSUE: The `.npmignore` appears to be messing with things.
          // See: builder-react-component/blob/master/init/.npmignore
          console.log("TODO HERE WALK", item.path); // eslint-disable-line no-console
